...
Acceptance includes 5/5 golden evaluations, Doctor ready, valid Export20, browser launch with no missing local assets, guided scenarios, optional local benchmark, and clean shutdown. Preserve v0.3.1 as the immediate source rollback and v0.1.2 as the older Windows support-evidence lineage until then.
